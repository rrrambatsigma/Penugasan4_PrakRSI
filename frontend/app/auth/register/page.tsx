...
export default function RegisterPage() {
  ...
  const handleRegister = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.success("Registrasi berhasil! Kamu akan diarahkan ke halaman login.");
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#e0e7ff,transparent_34%),linear-gradient(to_bottom,#ffffff,#f8fafc)] px-4 py-8 font-sans text-slate-900">
      <div className="mx-auto flex min-h-[calc(100vh-64px)] w-full max-w-6xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.12)] lg:grid-cols-[0.8fr_1.2fr]">
          <section className="relative hidden overflow-hidden bg-gradient-to-br from-indigo-600 via-violet-600 to-slate-950 p-10 text-white lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.12)_0%,transparent_35%,rgba(15,23,42,0.24)_100%)]" />
            ...
            <div className="relative">
              ...
              <div className="mt-20">
                <p className="text-sm font-bold uppercase tracking-[0.35em] text-indigo-100">
                  Acara RSI
                </p>

                <h1 className="mt-5 max-w-md text-4xl font-extrabold leading-tight tracking-tight">
                  Daftar akun dan mulai ikuti event pilihanmu.
                </h1>

                <p className="mt-5 max-w-md text-sm leading-7 text-indigo-100">
                  Temukan kompetisi menarik, buat akun dengan mudah, dan mulai
                  perjalananmu untuk menunjukkan kemampuan terbaik di setiap
                  event.
                </p>
              </div>
            </div>
          ...
          <section className="px-6 py-8 sm:px-8 lg:px-12 lg:py-10">
            <div className="mb-8">
              <Link
                href="/"
                className="mb-8 inline-flex text-sm font-semibold text-indigo-600 transition hover:text-indigo-700 lg:hidden"
              >
                ← Kembali ke Beranda
              </Link>
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Lengkapi data berikut untuk melakukan registrasi.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="mt-2 flex h-12 w-full items-center justify-center rounded-2xl bg-indigo-600 px-4 text-sm font-extrabold text-white shadow-lg shadow-indigo-200 transition hover:-translate-y-0.5 hover:bg-indigo-700 hover:shadow-indigo-300 disabled:cursor-not-allowed disabled:bg-indigo-300 disabled:hover:translate-y-0"
              >
                {isLoading ? "Memproses Registrasi..." : "Register"}
              </button>
            </form>
